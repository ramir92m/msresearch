...
<!--                                    <fieldset id="fieldset">
									...
									<tr>
										<td>Control Number:   &nbsp; &nbsp; &nbsp; <input type="text" name="cn1" class="span5"/></td>  
										<td>Control Number:   &nbsp; &nbsp; &nbsp;<input type="text" name="cn2" class="span5"/></td> 							
									</tr>
